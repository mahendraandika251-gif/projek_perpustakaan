...
<body class="bg-[#86b0f3] min-h-screen flex items-center justify-center p-4 selection:bg-black selection:text-white">
    ...
    <!-- Toast Notification (Pesan Notifikasi) -->
    <div id="toast" class="fixed top-5 right-5 z-50 transform translate-y-[-100px] opacity-0 transition-all duration-300 ease-in-out bg-gray-900 text-white px-5 py-3 rounded-lg shadow-xl flex items-center gap-3">
        <i id="toast-icon" class="fa-solid fa-circle-check text-green-400"></i>
        <span id="toast-message" class="text-sm font-medium">Pesan berhasil dikirim</span>
    </div>
    ...
    <div class="bg-white w-full max-w-[420px] rounded-sm shadow-[0_20px_50px_rgba(0,0,0,0.15)] p-8 sm:p-12 relative overflow-hidden transition-all duration-300">
        ...
        <div id="login-view" class="fade-in">
            ...
            <form onsubmit="handleLogin(event)" class="space-y-4">
                <!-- Input Username -->
                <div class="relative flex items-center border border-gray-400 bg-[#e0e0e0] focus-within:border-black transition-colors">
                ...
                <div class="text-center pt-2">
                    <button>
                    <a href="view/form_pendaftaran.php" class="text-xs text-black font-medium hover:underline focus:outline-none">
                      Register
                    </a>
